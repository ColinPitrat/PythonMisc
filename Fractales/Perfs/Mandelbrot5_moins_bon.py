...
def init():
    global img, cx, cy, x, y, ix, iy, expr1, expr2, expr3
...
def trf():
    global img, x, y, cx, cy, ix, iy, expr1, expr2, expr3
    if not len(x): return img
    tmp = numexpr.evaluate(expr1)
    y = numexpr.evaluate(expr2)
    x = tmp
    m = numexpr.evaluate(expr3)
